...
public class SeltafContext {
    ...
    //TestObject specific properties
    public static final String TESTOBJECT_API_KEY = "testobject_api_key";
    public static final String TESTOBJECT_APPID = "testobject_app_id";
    ...
    public SeltafContext(final ITestContext context) {
        ...
        setContextAttribute(context, TESTOBJECT_API_KEY, System.getProperty(TESTOBJECT_API_KEY), null);
        setContextAttribute(context, TESTOBJECT_APPID, System.getProperty(TESTOBJECT_APPID), null);
        setContextAttribute(context, TESTOBJECT_DEVICE, System.getProperty(TESTOBJECT_DEVICE), null);
    ...
    public String getTestObjectApiKey() {
        return (String) getAttribute(TESTOBJECT_API_KEY);
    }

    public String getTestObjectAppId() {
        return (String) getAttribute(TESTOBJECT_APPID);
    }

    public String getTestObjectDevice() {
        return (String) getAttribute(TESTOBJECT_DEVICE);
    }
