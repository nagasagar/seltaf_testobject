...
public class WebUtility {
    ...
    public void resizeWindow(final int width, final int height) {
        try {
            SeltafTestLogger.logWebStep(null, "Resize browser window to width " + width + " height " + height, false);
    ...
    public void maximizeWindow() {
        try {
            BrowserType browser = BrowserType.getBrowserType(DriverManager.getDriverManager().getBrowser());
            ...
            try {
            	...
            	SeltafTestLogger.log("Unable to maximize browser window. Exception occured: " + ignore.getMessage());
            }
        }
    }
