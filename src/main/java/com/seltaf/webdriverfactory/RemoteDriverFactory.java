...
import com.seltaf.driver.ScreenShotRemoteWebDriver;
	        ...
	        case FireFox :
                try {
                    ...
                    if (e.getMessage().contains(
                        ...
                        SeltafTestLogger.log("Firefox Driver creation got port customexception, retry after 5 seconds");
     ...
     // logging node ip address:
        try {
            ...
            try {
                ...
                SeltafTestLogger.log("WebDriver is running on node " + node + ", " + browserName + version + ", session "
                        + ((RemoteWebDriver) driver).getSessionId());
