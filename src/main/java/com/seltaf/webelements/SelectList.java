...
public class SelectList extends HtmlElement {
    ...
    public void deselectByText(final String text) {
        SeltafTestLogger.logWebStep(null, "deselect text\"" + text + "\" on " + toHTML(), false);
        findElement();
        for (WebElement option : options) {
    ...
    public void deselectByValue(final String value) {
        SeltafTestLogger.logWebStep(null, "deselect value\"" + value + "\" on " + toHTML(), false);
        findElement();
        for (WebElement option : options) {
    ...
    public void selectByIndex(final int index) {
        SeltafTestLogger.logWebStep(null, "make selection using index\"" + index + "\" on " + toHTML(), false);
        findElement();
    ...
    public void selectByIndex(final int[] indexs) {
        SeltafTestLogger.logWebStep(null, "make selection using indexs\"" + indexs.toString() + "\" on " + toHTML(), false);
        findElement();
    ...
    public void selectByText(final String[] texts) {
        SeltafTestLogger.logWebStep(null, "make selection using texts\"" + texts + "\" on " + toHTML(), false);
        findElement();
    ...
    public void selectByValue(final String value) {
        SeltafTestLogger.logWebStep(null, "make selection using value\"" + value + "\" on " + toHTML(), false);
        findElement();
        for (WebElement option : options) {
            if (option.getAttribute("value").equals(value)) {
                setSelected(option);
    ...
    public void selectByValue(final String[] values) {
        SeltafTestLogger.logWebStep(null, "make selection using values\"" + values + "\" on " + toHTML(), false);
        findElement();
